...
const deleteUser = async (username) => {
    if (!await dialog.confirmDelete(username, '用户'))
        return;
    try {
...
const deleteGroup = async (groupName) => {
    if (!await dialog.confirmDelete(groupName, '用户组'))
        return;
    try {
...
/** @type {__VLS_StyleScopedClasses['sub-nav-btn']} */ ;
/** @type {__VLS_StyleScopedClasses['dash-subtab']} */ ;
/** @type {__VLS_StyleScopedClasses['dash-subtab']} */ ;
...
if (__VLS_ctx.currentTab === 'dashboard') {
    __VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)({
        ...{ class: "tab-content tab-content-flush" },
    });
    /** @type {__VLS_StyleScopedClasses['tab-content']} */ ;
    /** @type {__VLS_StyleScopedClasses['tab-content-flush']} */ ;
    const __VLS_0 = AdminHouseDashboard;
    // @ts-ignore
...
if (__VLS_ctx.currentTab === 'users') {
    ...
    __VLS_asFunctionalElement1(__VLS_intrinsics.button, __VLS_intrinsics.button)({
        ...{ onClick: (...[$event]) => {
                ...
                // @ts-ignore
                [currentTab, currentTab, showAddUserModal,];
            } },
        ...{ class: "btn-primary" },
    });
...
if (__VLS_ctx.currentTab === 'accounts') {
    ...
    /** @type {__VLS_StyleScopedClasses['tab-content']} */ ;
    const __VLS_5 = AdminSlurmAccounts;
    // @ts-ignore
...
if (__VLS_ctx.currentTab === 'associations') {
    ...
    /** @type {__VLS_StyleScopedClasses['tab-content']} */ ;
    const __VLS_10 = AdminAssociations;
    // @ts-ignore
...
if (__VLS_ctx.currentTab === 'audit') {
    ...
    for (const [log] of __VLS_vFor((__VLS_ctx.filteredAuditLogs))) {
        ...
        (log.success ? '成功' : '失败');
        // @ts-ignore
        [currentTab, auditFilters, auditFilters, auditFilters, auditFilters, searchAuditLogs, filteredAuditLogs,];
    }
}
